/*! Yadhupooppadi - v1.0.0 - 2019-07-16 *//*! jQuery v3.3.1 | (c) JS Foundation and other contributors | jquery.org/license */
...
$(document).ready(function () {
	...
	$('.marker').click(function(){
		$('.markerAddress').toggleClass('show');
	});

	//SERVICE LIST SECTION  
  
	$('.service-LayerHolder .listedLayer').hover(function() {
 		$('.service-LayerHolder .listedLayer.viewItem').removeClass('viewItem');
 		$(this).addClass('viewItem');
	});
	
	//BACKGROUNT IMAGE FOR MOBILE
    
	if ($(window).width() < 991){
	   $(".img-wrpSm").each( function(){
	...
	//BACKGROUNT IMAGE FOR ALL DEVICE
	...
	$('.projectCarosal').slick({
		...
		variableWidth: true,
		arrows: true,
		prevArrow:'<svg class="slick-prev slick-arrow" width="31.6" height="31.6" viewBox="0 0 31.6 31.6"><g id="down-arrow" transform="translate(31.6) rotate(90)"><g id="Group_19" data-name="Group 19"><path id="Path_59" data-name="Path 59" d="M31.6,15.8A15.8,15.8,0,1,0,15.8,31.6,15.818,15.818,0,0,0,31.6,15.8Zm-30.021,0A14.221,14.221,0,1,1,15.8,30.021,14.237,14.237,0,0,1,1.579,15.8Z"/><path id="Path_60" data-name="Path 60" d="M169.793,141.478l4.44-4.44a.788.788,0,1,0-1.115-1.115l-3.093,3.093V127.193a.793.793,0,1,0-1.585,0V139.01l-3.093-3.093a.788.788,0,1,0-1.115,1.115l4.44,4.44a.8.8,0,0,0,1.121.006Z" transform="translate(-153.432 -118.255)"/></g></g></svg>',
		nextArrow:'<svg class="slick-next slick-arrow" width="31.6" height="31.6" viewBox="0 0 31.6 31.6"><g id="down-arrow2" transform="translate(0 31.6) rotate(-90)"><g id="Group_19" data-name="Group 19"><path id="Path_59" data-name="Path 59" d="M31.6,15.8A15.8,15.8,0,1,0,15.8,31.6,15.818,15.818,0,0,0,31.6,15.8Zm-30.021,0A14.221,14.221,0,1,1,15.8,30.021,14.237,14.237,0,0,1,1.579,15.8Z"/><path id="Path_60" data-name="Path 60" d="M169.793,141.478l4.44-4.44a.788.788,0,1,0-1.115-1.115l-3.093,3.093V127.193a.793.793,0,1,0-1.585,0V139.01l-3.093-3.093a.788.788,0,1,0-1.115,1.115l4.44,4.44a.8.8,0,0,0,1.121.006Z" transform="translate(-153.432 -118.255)"/></g></g></svg>',
		responsive: [
		{
			breakpoint: 1200,
			settings: {
	...
	if ($(window).width() > 1025) {
		var blogHeight = $('.xaqTab__List .blogText').outerHeight();
		$('.blogText').height(blogHeight);
	}
}); 
 
$(window).scroll(function(){ 
	//var stickheight = $('.sticky-menu').outerHeight();
	if( $(window).scrollTop() > 60){
		$('#xaQ-Header').addClass('header-top');
	}
	else{
		$('#xaQ-Header').removeClass('header-top');  
	}
});  
...
(function() {
	...
	//MENU MODAL CLOSE
	$(".overlay-close, #trigger-overlay").on("click", function(){
		if($(".xaQ-Menu-X .brand-icon.offmode").hasClass("offmode")){
			$(".brand-icon").removeClass("offmode");
		}else{
			$(".xaQ-Menu-X .brand-icon").addClass("offmode");
		}
	});
})();
//END MENU SVG ANIMATION
